...
process espresso {
    ...
    perl /espresso/src/ESPRESSO_S.pl -L sample_sheet.tsv -T ${params.espresso_cpus} --sort_buffer_size ${params.espresso_mem} -F ${params.refFa} -A ${params.refGTF} -O ${smpl_id}
